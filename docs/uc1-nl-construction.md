...
**Companions:** `conceptual-design.md` (v0.9) is authoritative for *what* and *why*; `technical-design.md` (v0.7) for the service set, build order, and substrate; the PS designs (`ps1-identity-service.md`, `ps2-record-spine.md`, `ps3-specs-service.md`, `ps7-data-service.md`, `ps14-work-service.md`, `ps15-agent-service.md`) for their own internals; `platform-standards.md` (v0.1) is this document's cross-domain twin. Precedence runs in that order and this document is wrong where it conflicts.
