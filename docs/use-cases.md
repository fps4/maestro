...
| **Alert** | The item stands on the answerable person's Today, marked with why; app1 keeps its own P1–P4 alerts, since maestro alerts only in its console in the MVP ([ADR-0023](decisions/0023-maestro-alerts-in-its-one-console.md)). | work-service, the console |
