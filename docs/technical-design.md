...
**Status:** Draft v1.3 — for refinement
**Repo:** mstr
**Companion:** `conceptual-design.md` (v1.1). That document is authoritative for *what* and *why*; this one is authoritative for *what we build first, on what, and in what order*. Where they conflict, the conceptual document wins and this one is wrong.
