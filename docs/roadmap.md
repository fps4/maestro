...
**Builds:** CDK stacks for identity-service and specs-service on Lambda; Atlas Flex; the S3 archive relay and SNS/SQS delivery; GitHub-hosted CI; the [signals module](signals.md) (Terraform + CDK construct) published; the self-hosted runner pool retired for these repositories.
