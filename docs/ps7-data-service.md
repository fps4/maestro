...
| 0.5 | 2026-09-15 | The empty `mstr-data` directory recorded in the header and in v0.4 is removed with the estate rename (technical design v1.5, §3.4). The reversed plan no longer sits on disk. Nothing else changed |
