...
|---|---|
| **The platform consumes rather than builds it** — someone else owns the roadmap and the ADRs | `identity-service` (PS1 auth), `specs-service` (PS3 + PS4) |
