...
**Repository:** `fps4/maestro`, in [`spine/`](../../spine/) · **Status:** building — the core, the S3 and SNS adapters, the sealer and the Terraform module are in code (below); the first component's relay follows in M1 · **Decision:** [ADR-0003](../decisions/0003-the-spine-is-an-archive-and-a-queue.md)
