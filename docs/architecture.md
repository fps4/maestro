...
| `fps4/maestro-specs` | specs-service, the CLI, the proposing Action | two consumers shaped its model |
| `fps4/maestro-work` | work-service | the estate's operations |
...
| `fps4/maestro` | this design; the spine and agent-service, which have no consumer but maestro | — |
| `fps4/maestro-config-<tenant>` | one tenant's configuration, private | the tenant |
